...
const userSchema = new Schema<IUser, IUserModel>(
  {
    ...
    profilePic: {type: String, default: "https://res.cloudinary.com/dpp7elupy/image/upload/v1655131058/profilePictures/default-profile-pic_dzma8t.jpg"},
    coverPic: {type: String, default: "https://res.cloudinary.com/dpp7elupy/image/upload/v1655195992/coverPictures/default-cover_xokejy.png"},
    mobile: String,
    dob: String,
